...
USE_NM = False                     # Enable Normalized Mutation
...
def run_dataset(dataset_name, num_runs, slim_version, base_seed, use_oms=False, use_nm=False,
    ...
    Args:
        ...
        use_oms: Enable OMS
        use_nm: Enable Normalized Mutation
...
def main():
    ...
    # Validate OMS/NM mutual exclusivity (module-level constants)
    if USE_OMS and USE_NM:
        print("⚠️  WARNING: USE_OMS and USE_NM are mutually exclusive.")
        print("   Please set only one of them to True in the configuration block. Aborting.")
        return
